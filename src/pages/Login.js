...
function login() {
  return (
    <main className="flex items-center justify-center lg:h-screen py-4 px-4 md:px-8">
      <div className="bg-white border border-slate-200 [box-shadow:rgba(149,157,165,0.3)_0px_4px_12px] rounded-lg p-6 max-w-lg md:max-w-2xl lg:max-w-6xl dark:bg-neutral-800 dark:border dark:border-neutral-700 dark:shadow-none">
        <a href="#" className="inline-block">
          <img
            src="https://readymadeui.com/readymadeui.svg"
            alt="logo"
            className="w-36 mb-8 lg:mb-0 dark:invert dark:brightness-100"
          />
        </a>
